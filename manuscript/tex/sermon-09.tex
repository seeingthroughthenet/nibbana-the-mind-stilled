...
But in the context \emph{chanda-iddhipāda},\footnote{E.g. at \href{https://suttacentral.net/pitaka/sutta/linked/sn/sn-mahavaggasamyutta/sn51}{SN 51 / S V 253}, \emph{Iddhipādasaṁyutta}} where the reference is to a particular base for success, it is reckoned as a skilful mental state. However, that is not a sufficient reason to regard it as something alien to the generic sense of the term.

...
Though this is the obvious meaning, some try to attribute quite a different meaning to the verse in question. The line \emph{paññāpetuṁ gati n'atthi}, ``there is no path to be pointed out'', is interpreted even by the commentators (who take the word \emph{gati} to mean some state of existence) as an assertion that, although such a bourne cannot be pointed out, the \emph{arahants} pass away into some non-descript realm.
